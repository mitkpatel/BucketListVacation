      ...
      <main className="p-10 container mx-auto px-6 md:px-0">
        ...
        <section>
          ...
          <div className="grid grid-cols-3 gap-4 mt-10">
            <div>
              <h3 className="text-lg font-semibold text-gray-500 mt-2">
                1. Browse and book the try trip
              </h3>
              <p className="text text-gray-400">
                Start by searching for a location. Once you find a location or
                trip you like, simply check the availability, book it, and make
                a secure payment right away.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-500 mt-2">
              ...
              <p className="text text-gray-400">
                Meet your host on the date you chose and enjoy the trip
            ...
            <div>
              ...
              <p className="text text-gray-400">
                ...
                review to your trip host. This way others will know where to go.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="relative">
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <button className="px-8 py-3 bg-slate-600 hover:bg-neutral-900 hover:text-white  ">Subscribe</button>
                    </div>
                  </div>
                </form>
              </div>
